...
class UserController extends Controller
{
    ...
    public function actionCreate()
    {
        ...
        if ($model->load(\App::$app->request->post()) && $model->save()) {
            \App::$app->authManager->assign(\App::$app->authManager->getRole($model->role), $model->id);
    ...
    public function actionUpdate($id)
    {
        ...
        if ($model->load(\App::$app->request->post()) && $model->save()) {
            \App::$app->authManager->revokeAll($id);
            \App::$app->authManager->assign(\App::$app->authManager->getRole($model->role), $id);
            return $this->redirect(['view', 'id' => $model->id]);
        } else {
