...
<div id="content">
	...
	<div class="main gywm">
    	<div class="left" id="left">
        	<ul>
                ...
                <?php if($left[2]['status']==1){?>
                    <li class="leib3  hover"><a href="<?= yii\helpers\Url::to(['about/partner']); ?>"><?= $left[2]['name'] ?></a></li>
                <?php
                } ?>
        ...
        <div class="right" id="right">
			<h2>合作伙伴</h2>
			 <div class="lxwm">
                <ul class="xj-module clearFloat">
                 <?php if($infos) { foreach ($infos as $K=>$V){?>
                     <li>
                         <div>
                             <img src="<?php echo $directoryAsset.$V['bannar']?>" alt="">
