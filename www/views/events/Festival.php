...
<article>
    <header>
        <img class="show-block" width="100%"  src="<?php echo $directoryAsset;?>/images/events/zhongqiu.jpg" alt="">
        <a class="use-hb" id="red_packet" href="#" onclick="changeit();" style="position: fixed; margin-bottom:5%;">分享红包</a>
    </header>
    <div id="mcover1" onclick=" document.getElementById('mcover1').style.display = 'none'; " style="display: none;"><img src="<?php echo $directoryAsset;?>/images/guide.png">
    </div>
</article>
</body>
