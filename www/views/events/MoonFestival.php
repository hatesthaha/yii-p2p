...
<div id="wrap">
    <div id="header" class="top">
        ...
        <div id= 'red_packet' style="padding-top: 310px; display:none;">
            <div class="hb">
                ...
                <a href="http://www.pgyer.com/licaiwang" class="use-hb">马上使用红包(仅限android用户参加)</a>
            </div>
        </div>
    ...
    <div id="footer" class="bottom clearFloat">
        <p class="phone-dow">
            <a href="http://www.pgyer.com/licaiwang"><img width="269px" height="70px" src="<?php echo $directoryAsset;?>/images/events/footer1.jpg" alt="安卓手机下载"></a>
