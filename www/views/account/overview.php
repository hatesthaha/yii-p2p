        ...
        <div style="background:#f6f6f6; border:none;" id="right" class="right">
            ...
            <div class="shadowBox page-con6">
                ...
                <div id="zhgk" class="page-con6con">
                    <div class="spage-con13">
                        <div class="spage-con131 clearFloat">
                            <div class="left">
                                <p>总资产：<span class="red-awod"> <?php echo number_format($infos_rar['amount_total'],2); ?>元</span></p>
                                <ul>
                                    <li>当前投资：<span class="cor4-f"><?php echo number_format($infos_rar['invest_total'],2); ?>元</span></li>
                                    <li>可用余额：<span class="cor4-f"><?php echo number_format($infos_rar['balance'],2); ?>元</span></li>
                                    <li>昨日收益：<span class="cor4-f"><?php echo number_format($infos_rar['income_yesterday'],2); ?>元</span></li>
                                </ul>
                            </div>
                            <div class="left">
                                <p>总收益：<span class="red-awod"><?php echo number_format($infos_rar['income_total'],2); ?>元</span></p>
                                <ul>
                                    <li>当前收益：<span class="cor4-f"><?php echo number_format($infos_rar['income_current'],2); ?>元</span></li>
                                    <li>冻结资金：<span class="cor4-f"><?php echo number_format($infos_rar['freeze'],2); ?>元</span></li>
                                     <li>体验金：<span class="cor4-f"><?php echo number_format($infos_rar['experience_money'],2); ?>元</span></li>
                                </ul>
                            </div>
                        </div>
                        <div class="spage-con132">
                            ...
                            <table class="spage-con132table Color-change">
                                ...
                                <?php if($infos_rar['invest_log']){foreach ($infos_rar['invest_log'] as $K=>$V) {?>
                                <tr>
                                    <td><?php echo $V['title']; ?></td>
                                    <td>￥<?php echo number_format($V['step'],2); ?>元</td>
                                    <td><?php echo date("Y-m-d H:i",$V['create_at']); ?></td>
                                </tr>
                                <?php } } else {?>
                                <tr class="spage-con163tacon">
                                 <td colspan="3" style="padding-top:30px;color:gray;font-size:14px;">暂无投资记录</td>
                                </tr>
                                <?php }?>
                            </tbody></table>
                ...
                <div id="tx" class="page-con6con">
                    <table class="page-con102 Color-change">
                ...
                <div id="bd" class="page-con6con">
                    <table class="page-con102 Color-change">
                        ...
                        <?php if(isset($infos_rar['array_tradelog'])) { foreach ($infos_rar['array_tradelog'] as $K => $V) {?>
                        <tr>
                            <td><?= $V['step'];?></td>
                            <td><?= $V['remark'];?></td>
                            <td><?=date('Y-m-d  H:i', $V['create_at']);?></td>
                   ...
                   <?php 
                   if(isset($infos_rar['array_tradelog'])) {
						// 显示分页
						echo LinkPager::widget([
