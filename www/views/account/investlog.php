...
<div class="main aqbz">
    	<div id="left" class="left">
            <div class="page-con4">
                <p class="page-con41"><a href="<?php echo yii\helpers\Url::to(['setting/setting']);?>"><img width="100px" height="100px" src="<?php  echo yii::$app->homeUrl;?>upload/<?php echo $model["person_face"]; ?>" alt="" /></a></p>
        ...
        <div style="background:#f6f6f6; border:none;" id="right" class="right">
            ...
            <div class="shadowBox page-con6">
                ...
                <div id="zhgk" class="page-con6con">
                    <div class="spage-con13">
                        ...
                        <div class="spage-con132">
                            ...
                            <table class="spage-con132table Color-change3">
                                <tbody><tr>
                                    <th>项目名称</th>
                                    <th>投资金额</th>
                                    <th>年化利率</th>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo date("Y-m-d",$V['create_at']+86400); ?></td>
                                </tr>
                                <?php }?>
                            </tbody></table>
                ...
                <div id="tx" class="page-con6con">
                    <table class="page-con102 Color-change3">
                        <tbody><tr class="trOdd">
                            <th>项目名称</th>
                            <th>投资金额</th>
                            <th>投资时间</th>
                        </tr>
                        <?php if($infos_rar['array_investlog']) { foreach ($infos_rar['array_investlog'] as $K => $V) {?>
                        <tr>
                            <td><?= $V['title'];?></td>
                ...
                <div id="bd" class="page-con6con">
                    <table class="page-con102 Color-change3">
                        ...
                        <?php if($infos_rar['array_tradelog']) { foreach ($infos_rar['array_tradelog'] as $K => $V) {?>
                        <tr>
                            <td><?= $V['step'];?></td>
                            <td><?= $V['remark'];?></td>
                            <td><?=date('Y-m-d  H:i', $V['create_at']);?></td>
                        ...
                        <?php }} else {?>
                         <tr class="spage-con163tacon">
                             <td colspan="3" style="padding-top:30px;color:red;font-size:14px;">暂无交易记录</td>
                         </tr>
                        <?php } ?>
                      </tbody>
                   </table>
    ...
    $(document).ready(function(){
        ...
        catoFram[1].style.display="block";
